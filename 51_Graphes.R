...
comparaison_entre_periodes_par_diplome <- readRDS("interm/comparaison_entre_periodes_par_diplome.rds") %>% filter(periode == "2017-2019")
...
(ggplot()+
  ...
  ggsave("graphes/diff_EVSI_entre_PCS.png",plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_ER_entre_PCS.png",plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot() + 
    geom_bar(data = ev_long, aes(x=diplome,y=valeur_esperance, fill=factor(type_esperance, levels=c("ev_limite_forte","ev_limite_moderee","evsi"))),
             position="stack", stat="identity")+
    labs(x="Diplôme",y="Années",fill="Espérance de vie \n à 30 ans")+
    scale_fill_brewer(breaks=c("evsi","ev_limite_moderee","ev_limite_forte"),
                      labels=c("sans incapacité","avec une incapacité \n modérée","avec une incapacité \n forte"),
                      palette="YlOrBr", direction=-1)+
    geom_hline(data = ev_moy_long, aes(yintercept=valeur_esperance), color="grey",linetype="dashed", show.legend=FALSE)+
    facet_wrap(~Sexe)+
    scale_y_continuous(breaks = seq(30, 65, by = 5), limits=c(0,60)))%>%
  ggsave("./graphes/EV_par_diplome.png", plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot() + 
    geom_bar(data = er_long, aes(x=diplome,y=valeur_esperance, fill=factor(type_esperance, levels=c("er_limite_forte","er_limite_moderee","ersi"))),
             position="stack", stat="identity")+
    labs(x="Diplôme",y="Années",fill="Espérance de retraite")+
    scale_fill_brewer(breaks=c("ersi","er_limite_moderee","er_limite_forte"),
                      labels=c("sans incapacité","avec une incapacité \n modérée","avec une incapacité \n forte"),
                      palette="YlOrBr", direction=-1)+
    geom_hline(data = er_moy_long, aes(yintercept=valeur_esperance), color="grey",linetype="dashed")+
    facet_wrap(~Sexe)+
    scale_y_continuous(breaks = seq(5, 30, by = 5)))%>%
  ggsave("graphes/ER_par_diplome.png",plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot() + 
    geom_bar(data = survie60_long, aes(x=diplome,y=valeur_esperance, fill=factor(type_esperance, levels=c("survie60_limite_forte","survie60_limite_moderee","survie60_non_limite"))),
             position="stack", stat="identity")+
    labs(x="Diplôme",y="Proportion",fill="Survie à 60 ans")+
    scale_fill_brewer(breaks=c("survie60_non_limite","survie60_limite_moderee","survie60_limite_forte"),
                      labels=c("sans incapacité","avec une incapacité \n modérée","avec une incapacité \n forte"),
                      palette="YlOrBr", direction=-1)+
    geom_hline(data = survie60_moy_long, aes(yintercept=valeur_esperance), color="grey",linetype="dashed")+
    facet_wrap(~Sexe)+
    scale_y_continuous(breaks = seq(0.5, 1, by = 0.05)))%>%
  ggsave("graphes/survie60_par_diplome.png",plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot(data = gradients_PCS_ponctuel, aes(x = PCS, y=valeur, color=type_limite, group=type_limite))+
  ...
  labs(x = "PCS",y ="Années", color="")+
  scale_color_brewer(palette="Paired")+
  scale_y_continuous(breaks=seq(-8,4,by=2))) %>%
  ggsave("graphes/gradients_PCS.png", plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot(data = gradients_diplome_ponctuel, aes(x = diplome, y=valeur, color=type_limite, group=type_limite))+
    ...
    geom_line()+
    facet_grid(type_esperance~Sexe)+
    labs(x = "Diplôme",y ="Années", color="")+
    scale_color_brewer(palette="Paired")+
    scale_y_continuous(breaks=seq(-8,4,by=2))) %>%
  ggsave("graphes/gradients_diplome.png", plot=., width=largeur, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_EVSI_entre_periodes_par_PCS.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_ER_entre_periodes_par_PCS.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_ERSI_entre_periodes_par_PCS.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_EVSI_entre_periodes_par_diplome.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_ER_entre_periodes_par_diplome.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_ERSI_entre_periodes_par_diplome.png",plot=., width=largeur*1.2, height=hauteur, unit="cm")
...
(ggplot()+
  ...
  ggsave("graphes/diff_entre_sexes.png",plot=., width=largeur, height=hauteur, unit="cm")
